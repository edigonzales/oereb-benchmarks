DELETE FROM 
    ${dbSchema}_wms.so_g_rb0220222wms_grundwasserschutzzonen
;
...
(
    ...
    WHERE 
        legende.thema = 'ch.Grundwasserschutzzonen'
)
,
dokumente AS 
(
...
DELETE FROM 
    ${dbSchema}_wms.so_g_rb0220222wms_grundwasserschutzareale
;
...
(
    ...
    FROM 
        ...
        ON eigentumsbeschraenkung.legende = legende.t_id 
    WHERE 
        legende.thema = 'ch.Grundwasserschutzareale'
)
,
dokumente AS 
(
